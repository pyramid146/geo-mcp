...
<div class="container">
  <section class="hero">
    ...
    <p class="sub">27 tools covering flood risk, property records, heritage,
      environmental designations, greenspace, geology, crime, coal mining,
      elevation, and geocoding — all built on UK open-data sources (ONS,
      Ordnance Survey, Environment Agency, Historic England, Natural
      England, BGS, HMLR, MHCLG, police.uk, Coal Authority). Returns
      decisions an LLM can act on, not raw polygons.</p>
    <div class="hero-ctas">
